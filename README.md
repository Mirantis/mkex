...
| ISO   | [Link](https://get.mirantis.com/bootc-mke3/images/bootc-mke3-r9.8-mcr29.6.1-mke3.9.5-bare-generic.iso)      | **Generic** ISO without any customisation. See [this document](docs/installation-guide/iso-editions.md#generic-image-customisation) to get the details on how to properly customise it | MCR 29.6.1 / MKE 3.9.5 |
| QCOW2 | [Link](https://get.mirantis.com/bootc-mke3/images/bootc-mke3-r9.8-mcr29.6.1-mke3.9.5-cloud.qcow2)      | Standard QEMU/KVM bootable image | MCR 29.6.1 / MKE 3.9.5 |
